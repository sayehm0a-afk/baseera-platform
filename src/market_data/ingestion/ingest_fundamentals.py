...
def _upsert_fundamental_snapshot(session: Session, stock: Stock, data: Dict) -> None:
    ...
    fields = dict(
        ...
        current_assets=_decimal_or_none(data.get("current_assets")),
        current_liabilities=_decimal_or_none(data.get("current_liabilities")),
        ...
        eps=_decimal_or_none(data.get("eps")),
    ...
    for symbol in symbols:
        ...
        try:
            ...
            if is_quota_exhausted_for_today(exc):
                logger.warning(
                    "ingest_fundamentals: stopping early -- SAHMK daily quota exhausted, "
