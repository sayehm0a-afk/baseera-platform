"""FROZEN pre-Phase-3 snapshot of src/analysis/decision_v2/engine.py,
vendored verbatim from commit fa2acfe for the DecisionEngineV2
historical validation harness (src.backtesting.decision_v2_baseline).
See types.py in this same package for the full provenance note. Every
submodule this file still imports from the LIVE src.analysis.decision_v2
package (evidence, reasoning, scoring, structure, config, gates,
market_risk, fundamental_summary, news_impact) is byte-for-byte
...
from src.analysis.decision_v2 import evidence, reasoning, scoring, structure
from src.backtesting.decision_v2_baseline import trade_classification
...
from src.backtesting.decision_v2_baseline.types import (
    DECISION_LABELS_AR,
