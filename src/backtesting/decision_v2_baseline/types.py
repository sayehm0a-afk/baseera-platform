"""FROZEN pre-Phase-3 snapshot of src/analysis/decision_v2/types.py,
vendored verbatim from commit fa2acfe (the last commit before Phase 3
area 1) for the DecisionEngineV2 historical validation harness
(src.backtesting.decision_v2_baseline). This package must NEVER be
imported by production code (src/api, src/market_intelligence) --
only by src/backtesting/. Do not edit by hand; if a future baseline
is needed, regenerate from the appropriate commit.
"""
