...
class Agent:
    ...
    يتضمن الوكيل معرفًا فريدًا، وقائمة بالقدرات، وحالة.
    """
    ...
    def __init__(
        ...
        Args:
            ...
            status (str): الحالة الأولية للوكيل (افتراضي: IDLE).
            metadata (Optional[Dict[str, Any]]): بيانات وصفية إضافية للوكيل.
        """
    ...
    def has_capability(self, capability: str) -> bool:
        """
        يتحقق مما إذا كان الوكيل يمتلك قدرة معينة.

        Args:
            capability (str): القدرة المراد التحقق منها.

        Returns:
            bool: True إذا كان الوكيل يمتلك القدرة، False بخلاف ذلك.
        """
        return capability in self.capabilities

    def to_dict(self) -> Dict[str, Any]:
        """
        يحول الوكيل إلى قاموس.

        Returns:
            Dict[str, Any]: تمثيل قاموسي للوكيل.
        """
        return {
            "id": self.id,
    ...
    def from_dict(cls, data: Dict[str, Any]):
        """
        ينشئ مثيل وكيل من قاموس.

        Args:
            data (Dict[str, Any]): قاموس يحتوي على بيانات الوكيل.
